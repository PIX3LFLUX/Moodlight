'''
Title           :CandidateExpNet_v.py
Description     :Candidate CNN class for emotion recognition with no pooling layer
...
class CandidateExpNet_v():
	def __init__(self, x, y, lr=1e-04, nClasses=8, imgXdim=84, imgYdim=84, batchSize=64, keepProb=0.5, squeezeCoefficient=1):
		...
		self.fcOutSize = 256 / squeezeCoefficient
	...
	def initParameters(self):
		...
		# fully connected, 3872 inputs, 256 / squeezeCoefficient outputs
