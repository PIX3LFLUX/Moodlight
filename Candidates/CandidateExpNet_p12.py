'''
Title           :CandidateExpNet_p12.py
Description     :Candidate CNN class for emotion recognition with two pooling layers
...
class CandidateExpNet_p12():
	def __init__(self, x, y, lr=1e-04, nClasses=8, imgXdim=84, imgYdim=84, batchSize=64, keepProb=0.5, squeezeCoefficient=1):
		...
		# Initialize parameters randomly and run Stage A
		self.initParameters()
